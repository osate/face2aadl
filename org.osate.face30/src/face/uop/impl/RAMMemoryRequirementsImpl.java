 ...
 * </p>
 * <ul>
 *   <li>{@link face.uop.impl.RAMMemoryRequirementsImpl#getHeapStackMin <em>Heap Stack Min</em>}</li>
 *   <li>{@link face.uop.impl.RAMMemoryRequirementsImpl#getHeapStackMax <em>Heap Stack Max</em>}</li>
 *   <li>{@link face.uop.impl.RAMMemoryRequirementsImpl#getHeapStackTypical <em>Heap Stack Typical</em>}</li>
 *   <li>{@link face.uop.impl.RAMMemoryRequirementsImpl#getTextMax <em>Text Max</em>}</li>
 *   <li>{@link face.uop.impl.RAMMemoryRequirementsImpl#getRoDataMax <em>Ro Data Max</em>}</li>
 *   <li>{@link face.uop.impl.RAMMemoryRequirementsImpl#getDataMax <em>Data Max</em>}</li>
 *   <li>{@link face.uop.impl.RAMMemoryRequirementsImpl#getBssMax <em>Bss Max</em>}</li>
 * </ul>
 *
 * @generated
 */
