	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ConceptualPackage.BASIS_ELEMENT: {
				...
				if (result == null) result = caseFace_Element(basisElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConceptualPackage.BASIS_ENTITY: {
				...
				if (result == null) result = caseFace_Element(basisEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConceptualPackage.DOMAIN: {
				...
				if (result == null) result = caseFace_Element(domain);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConceptualPackage.OBSERVABLE: {
				...
				if (result == null) result = caseFace_Element(observable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
