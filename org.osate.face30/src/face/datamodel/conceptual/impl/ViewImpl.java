 ...
 * </p>
 * <ul>
 *   <li>{@link face.datamodel.conceptual.impl.ViewImpl#getTraceabilityPoint <em>Traceability Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ViewImpl extends ElementImpl implements View {
	...
	protected EClass eStaticClass() {
		return ConceptualPackage.Literals.VIEW;
	}
	...
	public EList<TraceabilityPoint> getTraceabilityPoint() {
		if (traceabilityPoint == null) {
			traceabilityPoint = new EObjectContainmentEList<TraceabilityPoint>(TraceabilityPoint.class, this, ConceptualPackage.VIEW__TRACEABILITY_POINT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConceptualPackage.VIEW__TRACEABILITY_POINT:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == TraceableElement.class) {
			switch (derivedFeatureID) {
				case ConceptualPackage.VIEW__TRACEABILITY_POINT: return TraceabilityPackage.TRACEABLE_ELEMENT__TRACEABILITY_POINT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == TraceableElement.class) {
			switch (baseFeatureID) {
				case TraceabilityPackage.TRACEABLE_ELEMENT__TRACEABILITY_POINT: return ConceptualPackage.VIEW__TRACEABILITY_POINT;
				default: return -1;
			}
		}
