 ...
 * </p>
 * <ul>
 *   <li>{@link face.datamodel.conceptual.impl.DomainImpl#getBasisEntity <em>Basis Entity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DomainImpl extends ElementImpl implements Domain {
	...
	protected EClass eStaticClass() {
		return ConceptualPackage.Literals.DOMAIN;
	}
	...
	public EList<BasisEntity> getBasisEntity() {
		if (basisEntity == null) {
			basisEntity = new EObjectResolvingEList<BasisEntity>(BasisEntity.class, this, ConceptualPackage.DOMAIN__BASIS_ENTITY);
		}
		return basisEntity;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConceptualPackage.DOMAIN__BASIS_ENTITY:
