 ...
 * </p>
 * <ul>
 *   <li>{@link face.datamodel.logical.impl.CompositeQueryImpl#getTraceabilityPoint <em>Traceability Point</em>}</li>
 *   <li>{@link face.datamodel.logical.impl.CompositeQueryImpl#getComposition <em>Composition</em>}</li>
 *   <li>{@link face.datamodel.logical.impl.CompositeQueryImpl#getRealizes <em>Realizes</em>}</li>
 *   <li>{@link face.datamodel.logical.impl.CompositeQueryImpl#isIsUnion <em>Is Union</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompositeQueryImpl extends ElementImpl implements CompositeQuery {
	 ...
	 * @ordered
	 */
	protected face.datamodel.conceptual.CompositeQuery realizes;
	...
	protected EClass eStaticClass() {
		return LogicalPackage.Literals.COMPOSITE_QUERY;
	}
	...
	public EList<TraceabilityPoint> getTraceabilityPoint() {
		if (traceabilityPoint == null) {
			traceabilityPoint = new EObjectContainmentEList<TraceabilityPoint>(TraceabilityPoint.class, this, LogicalPackage.COMPOSITE_QUERY__TRACEABILITY_POINT);
		}
	...
	public EList<QueryComposition> getComposition() {
		if (composition == null) {
			composition = new EObjectContainmentEList<QueryComposition>(QueryComposition.class, this, LogicalPackage.COMPOSITE_QUERY__COMPOSITION);
		}
		return composition;
	}
	 ...
	 * @generated
	 */
	public face.datamodel.conceptual.CompositeQuery getRealizes() {
		if (realizes != null && realizes.eIsProxy()) {
			InternalEObject oldRealizes = (InternalEObject)realizes;
			realizes = (face.datamodel.conceptual.CompositeQuery)eResolveProxy(oldRealizes);
			if (realizes != oldRealizes) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LogicalPackage.COMPOSITE_QUERY__REALIZES, oldRealizes, realizes));
			}
		}
		return realizes;
	}
	 ...
	 * @generated
	 */
	public face.datamodel.conceptual.CompositeQuery basicGetRealizes() {
		return realizes;
	}
	 ...
	 * @generated
	 */
	public void setRealizes(face.datamodel.conceptual.CompositeQuery newRealizes) {
		face.datamodel.conceptual.CompositeQuery oldRealizes = realizes;
		realizes = newRealizes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogicalPackage.COMPOSITE_QUERY__REALIZES, oldRealizes, realizes));
	}
	...
	public void setIsUnion(boolean newIsUnion) {
		...
		isUnion = newIsUnion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogicalPackage.COMPOSITE_QUERY__IS_UNION, oldIsUnion, isUnion));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LogicalPackage.COMPOSITE_QUERY__TRACEABILITY_POINT:
				return ((InternalEList<?>)getTraceabilityPoint()).basicRemove(otherEnd, msgs);
			case LogicalPackage.COMPOSITE_QUERY__COMPOSITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case LogicalPackage.COMPOSITE_QUERY__REALIZES:
				if (resolve) return getRealizes();
				return basicGetRealizes();
			case LogicalPackage.COMPOSITE_QUERY__IS_UNION:
				return isIsUnion();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case LogicalPackage.COMPOSITE_QUERY__COMPOSITION:
				...
				return;
			case LogicalPackage.COMPOSITE_QUERY__REALIZES:
				setRealizes((face.datamodel.conceptual.CompositeQuery)newValue);
				return;
			case LogicalPackage.COMPOSITE_QUERY__IS_UNION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case LogicalPackage.COMPOSITE_QUERY__COMPOSITION:
				...
				return;
			case LogicalPackage.COMPOSITE_QUERY__REALIZES:
				setRealizes((face.datamodel.conceptual.CompositeQuery)null);
				return;
			case LogicalPackage.COMPOSITE_QUERY__IS_UNION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == TraceableElement.class) {
			switch (derivedFeatureID) {
				case LogicalPackage.COMPOSITE_QUERY__TRACEABILITY_POINT: return TraceabilityPackage.TRACEABLE_ELEMENT__TRACEABILITY_POINT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == TraceableElement.class) {
			switch (baseFeatureID) {
				case TraceabilityPackage.TRACEABLE_ELEMENT__TRACEABILITY_POINT: return LogicalPackage.COMPOSITE_QUERY__TRACEABILITY_POINT;
				default: return -1;
			}
		}
		if (baseClass == View.class) {
