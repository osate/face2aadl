 ...
 * </p>
 * <ul>
 *   <li>{@link face.datamodel.logical.impl.AssociationImpl#getParticipant <em>Participant</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssociationImpl extends EntityImpl implements Association {
	...
	protected EClass eStaticClass() {
		return LogicalPackage.Literals.ASSOCIATION;
	}
	...
	public EList<Participant> getParticipant() {
		if (participant == null) {
			participant = new EObjectContainmentEList<Participant>(Participant.class, this, LogicalPackage.ASSOCIATION__PARTICIPANT);
		}
		return participant;
	}
