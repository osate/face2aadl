...
/**
 * This is the item provider adapter for a {@link org.osate.datamodel10.platform.Composition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositionItemProvider extends CharacteristicItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Composition_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Composition_type_feature", "_UI_Composition_type"),
				 PlatformPackage.Literals.COMPOSITION__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRealizesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Composition_realizes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Composition_realizes_feature", "_UI_Composition_type"),
				 PlatformPackage.Literals.COMPOSITION__REALIZES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPrecisionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Composition_precision_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Composition_precision_feature", "_UI_Composition_type"),
				 PlatformPackage.Literals.COMPOSITION__PRECISION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Composition)object).getRolename();
