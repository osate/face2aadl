...
/**
 * This is the item provider adapter for a {@link org.osate.datamodel10.platform.StructMember} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StructMemberItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PlatformPackage.Literals.STRUCT_MEMBER__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRolenamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StructMember_rolename_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StructMember_rolename_feature", "_UI_StructMember_type"),
				 PlatformPackage.Literals.STRUCT_MEMBER__ROLENAME,
				 true,
				 false,
				 false,
	...
	protected void addPrecisionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StructMember_precision_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StructMember_precision_feature", "_UI_StructMember_type"),
				 PlatformPackage.Literals.STRUCT_MEMBER__PRECISION,
				 true,
				 false,
				 false,
	...
	protected void addRealizesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StructMember_realizes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StructMember_realizes_feature", "_UI_StructMember_type"),
				 PlatformPackage.Literals.STRUCT_MEMBER__REALIZES,
				 true,
				 false,
				 true,
				 null,
