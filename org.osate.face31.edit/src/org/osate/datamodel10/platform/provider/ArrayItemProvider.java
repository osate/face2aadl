...
/**
 * This is the item provider adapter for a {@link org.osate.datamodel10.platform.Array} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayItemProvider extends PrimitiveItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Array_size_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Array_size_feature", "_UI_Array_type"),
				 PlatformPackage.Literals.ARRAY__SIZE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Array.class)) {
			case PlatformPackage.ARRAY__SIZE:
