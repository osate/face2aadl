...
/**
 * This is the item provider adapter for a {@link org.osate.datamodel10.platform.Struct} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StructItemProvider extends PlatformDataTypeItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PlatformPackage.Literals.STRUCT__MEMBER);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Struct.class)) {
			case PlatformPackage.STRUCT__MEMBER:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PlatformPackage.Literals.STRUCT__MEMBER,
				 PlatformFactory.eINSTANCE.createStructMember()));
	}
