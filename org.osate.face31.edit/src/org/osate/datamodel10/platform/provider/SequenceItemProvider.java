...
/**
 * This is the item provider adapter for a {@link org.osate.datamodel10.platform.Sequence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SequenceItemProvider extends PrimitiveItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sequence_maxSize_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sequence_maxSize_feature", "_UI_Sequence_type"),
				 PlatformPackage.Literals.SEQUENCE__MAX_SIZE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Sequence.class)) {
			case PlatformPackage.SEQUENCE__MAX_SIZE:
