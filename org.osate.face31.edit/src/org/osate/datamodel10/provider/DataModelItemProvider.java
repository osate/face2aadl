...
/**
 * This is the item provider adapter for a {@link org.osate.datamodel10.DataModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataModelItemProvider extends ElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DatamodelPackage.Literals.DATA_MODEL__CDM);
			childrenFeatures.add(DatamodelPackage.Literals.DATA_MODEL__LDM);
			childrenFeatures.add(DatamodelPackage.Literals.DATA_MODEL__PDM);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DatamodelPackage.Literals.DATA_MODEL__CDM,
				 DatamodelFactory.eINSTANCE.createConceptualDataModel()));

		newChildDescriptors.add
			(createChildParameter
				(DatamodelPackage.Literals.DATA_MODEL__LDM,
				 DatamodelFactory.eINSTANCE.createLogicalDataModel()));

		newChildDescriptors.add
			(createChildParameter
				(DatamodelPackage.Literals.DATA_MODEL__PDM,
