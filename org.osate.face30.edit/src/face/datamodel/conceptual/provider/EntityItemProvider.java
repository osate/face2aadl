...
/**
 * This is the item provider adapter for a {@link face.datamodel.conceptual.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider extends ComposableElementItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addBasisEntityPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_specializes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_specializes_feature", "_UI_Entity_type"),
				 ConceptualPackage.Literals.ENTITY__SPECIALIZES,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Basis Entity feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBasisEntityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_basisEntity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_basisEntity_feature", "_UI_Entity_type"),
				 ConceptualPackage.Literals.ENTITY__BASIS_ENTITY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConceptualPackage.Literals.ENTITY__COMPOSITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConceptualPackage.Literals.ENTITY__COMPOSITION,
				 ConceptualFactory.eINSTANCE.createComposition()));
	}
