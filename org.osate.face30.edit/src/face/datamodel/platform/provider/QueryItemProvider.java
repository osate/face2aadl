...
/**
 * This is the item provider adapter for a {@link face.datamodel.platform.Query} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QueryItemProvider extends ElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Query_realizes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Query_realizes_feature", "_UI_Query_type"),
				 PlatformPackage.Literals.QUERY__REALIZES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSpecificationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Query_specification_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Query_specification_feature", "_UI_Query_type"),
				 PlatformPackage.Literals.QUERY__SPECIFICATION,
				 true,
				 false,
				 false,
