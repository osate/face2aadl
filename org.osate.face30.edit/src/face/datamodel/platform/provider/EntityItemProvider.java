...
/**
 * This is the item provider adapter for a {@link face.datamodel.platform.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider extends ComposableElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_realizes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_realizes_feature", "_UI_Entity_type"),
				 PlatformPackage.Literals.ENTITY__REALIZES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PlatformPackage.Literals.ENTITY__SPECIALIZES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PlatformPackage.Literals.ENTITY__COMPOSITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PlatformPackage.Literals.ENTITY__COMPOSITION,
				 PlatformFactory.eINSTANCE.createComposition()));
	}
