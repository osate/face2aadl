...
/**
 * This is the item provider adapter for a {@link face.datamodel.logical.CompositeQuery} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeQueryItemProvider extends ElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CompositeQuery_realizes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CompositeQuery_realizes_feature", "_UI_CompositeQuery_type"),
				 LogicalPackage.Literals.COMPOSITE_QUERY__REALIZES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LogicalPackage.Literals.COMPOSITE_QUERY__IS_UNION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LogicalPackage.Literals.COMPOSITE_QUERY__COMPOSITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LogicalPackage.Literals.COMPOSITE_QUERY__COMPOSITION,
				 LogicalFactory.eINSTANCE.createQueryComposition()));
	}
