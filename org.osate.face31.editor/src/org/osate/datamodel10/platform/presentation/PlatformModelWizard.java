...
public class PlatformModelWizard extends Wizard implements INewWizard {
	...
	public static final List<String> FILE_EXTENSIONS =
		Collections.unmodifiableList(Arrays.asList(Face31EditorPlugin.INSTANCE.getString("_UI_PlatformEditorFilenameExtensions").split("\\s*,\\s*")));
	...
	public static final String FORMATTED_FILE_EXTENSIONS =
		Face31EditorPlugin.INSTANCE.getString("_UI_PlatformEditorFilenameExtensions").replaceAll("\\s*,\\s*", ", ");
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setDefaultPageImageDescriptor(ExtendedImageRegistry.INSTANCE.getImageDescriptor(Face31EditorPlugin.INSTANCE.getImage("full/wizban/NewPlatform")));
	}
	...
	public void addPages() {
		...
		initialObjectCreationPage.setTitle(Face31EditorPlugin.INSTANCE.getString("_UI_PlatformModelWizard_label"));
