...
import org.osate.datamodel10.conceptual.presentation.ConceptualEditor;

import org.osate.datamodel10.logical.presentation.LogicalEditor;

import org.osate.datamodel10.platform.presentation.PlatformEditor;

import org.osate.datamodel10.presentation.DatamodelEditor;

import org.osate.face31.integration.presentation.IntegrationEditor;

import org.osate.face31.traceability.presentation.TraceabilityEditor;

import org.osate.face31.uop.presentation.UopEditor;
 ...
 * @generated
 */
public final class Face31EditorAdvisor extends WorkbenchAdvisor {
	/**
	...
	private static String[] getFileExtensionFilters() {
		...
		result.addAll(FaceEditor.FILE_EXTENSION_FILTERS);
		result.addAll(UopEditor.FILE_EXTENSION_FILTERS);
		result.addAll(IntegrationEditor.FILE_EXTENSION_FILTERS);
		result.addAll(TraceabilityEditor.FILE_EXTENSION_FILTERS);
		result.addAll(DatamodelEditor.FILE_EXTENSION_FILTERS);
		result.addAll(ConceptualEditor.FILE_EXTENSION_FILTERS);
		result.addAll(LogicalEditor.FILE_EXTENSION_FILTERS);
		result.addAll(PlatformEditor.FILE_EXTENSION_FILTERS);
	...
	private static String getString(String key, Object s1) {
		return org.osate.face31.presentation.Face31EditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
	...
	public static class Application implements IApplication {
		...
		public Object start(IApplicationContext context) throws Exception {
			WorkbenchAdvisor workbenchAdvisor = new Face31EditorAdvisor();
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "org.osate.face31.presentation.Face31EditorAdvisorPerspective";
	...
	/**
	 * Open action for the objects from the Face31 model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Open URI action for the objects from the Face31 model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
