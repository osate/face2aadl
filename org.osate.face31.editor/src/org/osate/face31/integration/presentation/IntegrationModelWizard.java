...
public class IntegrationModelWizard extends Wizard implements INewWizard {
	...
	public static final List<String> FILE_EXTENSIONS =
		Collections.unmodifiableList(Arrays.asList(Face31EditorPlugin.INSTANCE.getString("_UI_IntegrationEditorFilenameExtensions").split("\\s*,\\s*")));
	...
	public static final String FORMATTED_FILE_EXTENSIONS =
		Face31EditorPlugin.INSTANCE.getString("_UI_IntegrationEditorFilenameExtensions").replaceAll("\\s*,\\s*", ", ");
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setDefaultPageImageDescriptor(ExtendedImageRegistry.INSTANCE.getImageDescriptor(Face31EditorPlugin.INSTANCE.getImage("full/wizban/NewIntegration")));
	}
	...
	public void addPages() {
		...
		initialObjectCreationPage.setTitle(Face31EditorPlugin.INSTANCE.getString("_UI_IntegrationModelWizard_label"));
