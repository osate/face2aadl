 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.datamodel10.logical.impl.ParticipantPathNodeImpl#getProjectedParticipant <em>Projected Participant</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParticipantPathNodeImpl extends PathNodeImpl implements ParticipantPathNode {
	...
	protected EClass eStaticClass() {
		return LogicalPackage.Literals.PARTICIPANT_PATH_NODE;
	}
		...
		if (projectedParticipant != null && projectedParticipant.eIsProxy()) {
			...
			if (projectedParticipant != oldProjectedParticipant) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LogicalPackage.PARTICIPANT_PATH_NODE__PROJECTED_PARTICIPANT, oldProjectedParticipant, projectedParticipant));
			}
		}
	...
	public void setProjectedParticipant(Participant newProjectedParticipant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogicalPackage.PARTICIPANT_PATH_NODE__PROJECTED_PARTICIPANT, oldProjectedParticipant, projectedParticipant));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LogicalPackage.PARTICIPANT_PATH_NODE__PROJECTED_PARTICIPANT:
