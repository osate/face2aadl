...
public class LogicalPackageImpl extends EPackageImpl implements LogicalPackage {
	 ...
	 * @see org.osate.datamodel10.logical.LogicalPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		enumerationLabelEClass.getESuperTypes().add(theDatamodelPackage.getElement());
		...
		referencePointEClass.getESuperTypes().add(theDatamodelPackage.getElement());
		valueTypeUnitEClass.getESuperTypes().add(this.getElement());
		valueTypeUnitEClass.getESuperTypes().add(this.getAbstractMeasurement());
		constraintEClass.getESuperTypes().add(theDatamodelPackage.getElement());
		...
		initEClass(stringEClass, org.osate.datamodel10.logical.String.class, "String", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(characterEClass, org.osate.datamodel10.logical.Character.class, "Character", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(booleanEClass, org.osate.datamodel10.logical.Boolean.class, "Boolean", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(numericEClass, Numeric.class, "Numeric", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(integerEClass, org.osate.datamodel10.logical.Integer.class, "Integer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEAttribute(getStandardMeasurementSystem_ReferenceStandard(), ecorePackage.getEString(), "referenceStandard", null, 1, 1, StandardMeasurementSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
