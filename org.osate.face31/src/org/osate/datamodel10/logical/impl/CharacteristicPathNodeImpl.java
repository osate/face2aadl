 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.datamodel10.logical.impl.CharacteristicPathNodeImpl#getProjectedCharacteristic <em>Projected Characteristic</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CharacteristicPathNodeImpl extends PathNodeImpl implements CharacteristicPathNode {
	...
	protected EClass eStaticClass() {
		return LogicalPackage.Literals.CHARACTERISTIC_PATH_NODE;
	}
		...
		if (projectedCharacteristic != null && projectedCharacteristic.eIsProxy()) {
			...
			if (projectedCharacteristic != oldProjectedCharacteristic) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LogicalPackage.CHARACTERISTIC_PATH_NODE__PROJECTED_CHARACTERISTIC, oldProjectedCharacteristic, projectedCharacteristic));
			}
		}
	...
	public void setProjectedCharacteristic(Characteristic newProjectedCharacteristic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogicalPackage.CHARACTERISTIC_PATH_NODE__PROJECTED_CHARACTERISTIC, oldProjectedCharacteristic, projectedCharacteristic));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LogicalPackage.CHARACTERISTIC_PATH_NODE__PROJECTED_CHARACTERISTIC:
