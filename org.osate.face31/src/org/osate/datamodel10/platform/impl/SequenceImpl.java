 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.datamodel10.platform.impl.SequenceImpl#getMaxSize <em>Max Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SequenceImpl extends PrimitiveImpl implements Sequence {
	/**
	...
	protected EClass eStaticClass() {
		return PlatformPackage.Literals.SEQUENCE;
	}
	...
	public void setMaxSize(int newMaxSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlatformPackage.SEQUENCE__MAX_SIZE, oldMaxSize, maxSize));
	}
