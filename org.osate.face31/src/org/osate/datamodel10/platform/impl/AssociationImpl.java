 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.datamodel10.platform.impl.AssociationImpl#getParticipant <em>Participant</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssociationImpl extends EntityImpl implements Association {
	...
	protected EClass eStaticClass() {
		return PlatformPackage.Literals.ASSOCIATION;
	}
	...
	public EList<Participant> getParticipant() {
		if (participant == null) {
			participant = new EObjectContainmentEList<Participant>(Participant.class, this, PlatformPackage.ASSOCIATION__PARTICIPANT);
		}
		return participant;
	}
