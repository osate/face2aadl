 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.datamodel10.conceptual.impl.CompositionImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompositionImpl extends CharacteristicImpl implements Composition {
	...
	protected EClass eStaticClass() {
		return ConceptualPackage.Literals.COMPOSITION;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConceptualPackage.COMPOSITION__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(ComposableElement newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConceptualPackage.COMPOSITION__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConceptualPackage.COMPOSITION__TYPE:
