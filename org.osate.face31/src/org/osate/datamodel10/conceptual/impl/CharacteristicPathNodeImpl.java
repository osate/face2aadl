 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.datamodel10.conceptual.impl.CharacteristicPathNodeImpl#getProjectedCharacteristic <em>Projected Characteristic</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CharacteristicPathNodeImpl extends PathNodeImpl implements CharacteristicPathNode {
	...
	protected EClass eStaticClass() {
		return ConceptualPackage.Literals.CHARACTERISTIC_PATH_NODE;
	}
		...
		if (projectedCharacteristic != null && projectedCharacteristic.eIsProxy()) {
			...
			if (projectedCharacteristic != oldProjectedCharacteristic) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConceptualPackage.CHARACTERISTIC_PATH_NODE__PROJECTED_CHARACTERISTIC, oldProjectedCharacteristic, projectedCharacteristic));
			}
		}
	...
	public void setProjectedCharacteristic(Characteristic newProjectedCharacteristic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConceptualPackage.CHARACTERISTIC_PATH_NODE__PROJECTED_CHARACTERISTIC, oldProjectedCharacteristic, projectedCharacteristic));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConceptualPackage.CHARACTERISTIC_PATH_NODE__PROJECTED_CHARACTERISTIC:
