 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.datamodel10.conceptual.impl.ParticipantPathNodeImpl#getProjectedParticipant <em>Projected Participant</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParticipantPathNodeImpl extends PathNodeImpl implements ParticipantPathNode {
	...
	protected EClass eStaticClass() {
		return ConceptualPackage.Literals.PARTICIPANT_PATH_NODE;
	}
		...
		if (projectedParticipant != null && projectedParticipant.eIsProxy()) {
			...
			if (projectedParticipant != oldProjectedParticipant) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConceptualPackage.PARTICIPANT_PATH_NODE__PROJECTED_PARTICIPANT, oldProjectedParticipant, projectedParticipant));
			}
		}
	...
	public void setProjectedParticipant(Participant newProjectedParticipant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConceptualPackage.PARTICIPANT_PATH_NODE__PROJECTED_PARTICIPANT, oldProjectedParticipant, projectedParticipant));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConceptualPackage.PARTICIPANT_PATH_NODE__PROJECTED_PARTICIPANT:
