 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.face31.uop.impl.LifeCycleManagementPortImpl#getMessageExchangeType <em>Message Exchange Type</em>}</li>
 *   <li>{@link org.osate.face31.uop.impl.LifeCycleManagementPortImpl#getLcmMessageType <em>Lcm Message Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LifeCycleManagementPortImpl extends MinimalEObjectImpl.Container implements LifeCycleManagementPort {
	 ...
	 * @ordered
	 */
	protected MessageType lcmMessageType;
	 ...
	 * @generated
	 */
	public MessageType basicGetLcmMessageType() {
		return lcmMessageType;
	}
	 ...
	 */
	@Override
	public void setLcmMessageType(MessageType newLcmMessageType) {
		MessageType oldLcmMessageType = lcmMessageType;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case UopPackage.LIFE_CYCLE_MANAGEMENT_PORT__MESSAGE_EXCHANGE_TYPE:
				...
				return;
			case UopPackage.LIFE_CYCLE_MANAGEMENT_PORT__LCM_MESSAGE_TYPE:
				setLcmMessageType((MessageType)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case UopPackage.LIFE_CYCLE_MANAGEMENT_PORT__MESSAGE_EXCHANGE_TYPE:
				...
				return;
			case UopPackage.LIFE_CYCLE_MANAGEMENT_PORT__LCM_MESSAGE_TYPE:
				setLcmMessageType((MessageType)null);
				return;
		}
