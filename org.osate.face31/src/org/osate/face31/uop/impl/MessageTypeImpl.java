 ...
 * </p>
 * <ul>
 *   <li>{@link org.osate.face31.uop.impl.MessageTypeImpl#getTraceabilityPoint <em>Traceability Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MessageTypeImpl extends ElementImpl implements MessageType {
	/**
	...
	protected EClass eStaticClass() {
		return UopPackage.Literals.MESSAGE_TYPE;
	}
	...
	public EList<TraceabilityPoint> getTraceabilityPoint() {
		if (traceabilityPoint == null) {
			traceabilityPoint = new EObjectContainmentEList<TraceabilityPoint>(TraceabilityPoint.class, this, UopPackage.MESSAGE_TYPE__TRACEABILITY_POINT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UopPackage.MESSAGE_TYPE__TRACEABILITY_POINT:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == TraceableElement.class) {
			switch (derivedFeatureID) {
				case UopPackage.MESSAGE_TYPE__TRACEABILITY_POINT: return TraceabilityPackage.TRACEABLE_ELEMENT__TRACEABILITY_POINT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == TraceableElement.class) {
			switch (baseFeatureID) {
				case TraceabilityPackage.TRACEABLE_ELEMENT__TRACEABILITY_POINT: return UopPackage.MESSAGE_TYPE__TRACEABILITY_POINT;
				default: return -1;
			}
		}
